        ...
        Route::middleware(['auth', 'Is_Active'])->group(function () {
            ...
            // Route::prefix('inventory')->group(function() {
                ...
                Route::prefix('products')->group(function() {
                    Route::get('/products/createkit', 'ProductsController@create_kit')->name('products_kit');
                    ...
                    Route::post('/convert-currency', 'ProductsController@convertCurrency');
                    ...
                    Route::get('print_labels_bulk', 'ProductsController@print_labels_bulk')->name('print_labels_bulk');
                    Route::post('print_labels_bulk', 'ProductsController@generate_labels_bulk')->name('generate_labels_bulk');
