...
<div class="row" id="add_sale_return">
  <div class="col-lg-12 mb-3">
    <validation-observer ref="create_sale_return">
      <form @submit.prevent="Submit_sale_return">
              ...
              <div class="form-group col-md-4">
               ...
               <div class="form-group col-md-4">
                ...
                <select class="form-select" id="inputGroupSelect02"
                  @change="Calcul_Total()" v-model="sale_return.discount_type">
                ...
                <table class="table table-striped table-sm">
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <span>{{$currency}} @{{sale_return.TaxNet.toFixed(2)}} (@{{formatNumber(sale_return.tax_rate,2)}}
                          %)</span>
                      </td>
                    </tr>
                    <tr>
                      <td class="bold">{{ __('translate.Discount') }}</td>
                      <td v-if="sale_return.discount_type == 'fixed'"><span>{{$currency}} @{{sale_return.discount.toFixed(2)}}</span></td>
                      <td v-else> <span>{{$currency}} @{{sale_return.discount_percent_total.toFixed(2)}} (@{{formatNumber(sale_return.discount,2)}} %)</span></td>
                    </tr>
                    <tr>
        ...
        <div class="row mt-3">
          <div class="col-lg-6">
            <button @click="Submit_sale_return" class="btn btn-primary" :disabled="SubmitProcessing">
    ...
    Calcul_Total() {
      ...
      create_sale_return() {
        this.verifiedForm();
          ...
          NProgress.set(0.1);
          axios
            .post("/sales-return/returns_sale", {
