...
>
    <div class="sidebar-header mb-5 d-flex justify-content-center align-items-center">
        <div class="d-flex align-items-center">
            <!--<img class="app-logo me-2" width="90-->
            <!--" style="color:white" src="{{asset('images/'.$setting->logo)}}" alt="">-->
             <img class="app-logo me-2" width="90
            " style="color:white" src="{{asset('images/1-01.png')}}" alt="">
        </div>
    ...
    <div class="scroll-nav" data-perfect-scrollbar data-suppress-scroll-x="true">
        <ul x-data="collapse('{{$parentPath}}')" class="list-group" id="menu" style="list-style: none; margin-top: -21px">
            {{-- Dashboard --}}
            <li class="" >
                        ...
                        <ul class="list-group">
                            ...
                            @can('products_add')
                                <li>
                                 ...
                                 <li>
                                    @include('components.sidebar.child-navitem', [
                                        'href'=>'/products/products/createkit', 
                                        'title'=> __('translate.AddProductKit')
                                    ])
                                </li>
                            @endcan
                            @can('print_labels')
                                ...
                                <li>
                                    @include('components.sidebar.child-navitem', [
                                        'href'=>'/products/print_labels_bulk', 
                                        'title'=> __('translate.Print_Labels_Bulk')
                                    ])
                                </li>
                            @endcan
                            @can('category')
