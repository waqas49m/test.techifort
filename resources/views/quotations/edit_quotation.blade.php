...
<div class="breadcrumb">
  <h1>{{ __('translate.Edit_Quotation') }}</h1>
</div>

<div class="separator-breadcrumb border-top"></div>


<div class="row" id="section_edit_quotation">
  <div class="col-lg-12 mb-3">
    <validation-observer ref="edit_quote">
      <form @submit.prevent="Submit_Quotation">
        ...
        <div class="row mt-3">
          <div class="col-lg-6">
            <button @click="Submit_Quotation" class="btn btn-primary" :disabled="SubmitProcessing">
...
<script>
    ...
    var app = new Vue({
        ...
        data: {
          ...
          quote:@json($quote),
          total: 0,
          GrandTotal: @json($quote['GrandTotal']),
          product: {
            id: "",
            code: "",
            stock: "",
   ...
   // Search Products
    ...
    Update_Quotation() {
      if (this.verifiedForm()) {
        ...
        NProgress.set(0.1);
        axios
          .put('/quotation/quotations/'+ this.quote.id, {
